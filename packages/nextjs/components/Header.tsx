        ...
        return (
          <li key={href}>
            <Link
              ...
              passHref
              className={`${
                isActive ? "bg-purple-600/30 shadow-lg shadow-purple-500/20 text-white" : "text-gray-300"
              } hover:bg-purple-500/20 hover:text-white hover:shadow-md hover:shadow-purple-500/20 focus:!bg-purple-600/30 active:!text-white py-1.5 px-3 text-sm rounded-full gap-2 grid grid-flow-col transition-all duration-200`}
            >
              {icon}
              <span>{label}</span>
            </Link>
      ...
      <div className="navbar-start w-auto lg:w-1/2">
        ...
        <Link href="/" passHref className="hidden lg:flex items-center gap-2 ml-4 mr-6 shrink-0">
          ...
          <div className="flex flex-col">
            <span className="font-bold leading-tight text-white">3,3 Dice Game</span>
          </div>
        </Link>
